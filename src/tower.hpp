...
class Tower {
    ...
    Tower() : damage_(20), range_(50), attackSpeed_(1.2), value_(100), upgradePrice_(75), level_(1), texture_("snowman_basic.png") {}

    Tower(double damage, double range, double attackSpeed, double value, double upgradePrice, int level, std::string texture) 
    : damage_(damage), range_(range), attackSpeed_(attackSpeed), value_(value), upgradePrice_(upgradePrice), level_(level), texture_(texture) {}
